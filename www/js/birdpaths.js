...
var compulsorytrack = "./sounds/MPB7_test2.mp3"

var compulsoryhumantrack = "./sounds/MPH1_test.mp3"
...
export function humanpaths(svg, audioContext){
	...
	var randnarray = [0,1]
	humanlist[0].addSound(compulsoryhumantrack, false)
	//compulsory audio tracks
